    ...
    public partial class HierarchyNode : ICustomTypeDescriptor
    {
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            ...
            foreach (Property property in this.Properties)
            {
                ...
                if (property.AssemblyQualifiedNameOfPropertyGridEditorType != null)
                    attrs.Add(new EditorAttribute(property.AssemblyQualifiedNameOfPropertyGridEditorType, "System.Drawing.Design.UITypeEditor, System.Drawing, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"));
