...
namespace X.Editor.Model
{
    ...
    {
        internal Property CreateBoundedPropertyFor<T, U>(T targetObject, Expression<Func<T, U>> expression, string name = null, bool isReadonly = false, string description = null, string category = null)
        {
    ...
    public class Property
    {
        ...
        /// this property.
        /// </summary>
        public string AssemblyQualifiedNameOfPropertyGridEditorType { get; set; }
