...
namespace Book.Services.Crypto
{
    public class BigInteger2
    {
        ...
        private static readonly BigInteger2[] SMALL_CONSTANTS = new BigInteger2[17];
        public static readonly BigInteger2 Zero;
        public static readonly BigInteger2 One;
        public static readonly BigInteger2 Two;
        public static readonly BigInteger2 Three;
        public static readonly BigInteger2 Ten;
        ...
        private static readonly BigInteger2 radix2, radix2E, radix8, radix8E, radix10, radix10E, radix16, radix16E;
        ...
        static BigInteger2()
        {
            Zero = new BigInteger2(0, ZeroMagnitude, false);
            Zero.nBits = 0;
            Zero.nBitLength = 0;
        ...
        internal static BigInteger2 Arbitrary(int sizeInBits)
        {
            return new BigInteger2(sizeInBits, RandomSource);
        }
        ...
        {
            if (str.Length == 0)
                throw new FormatException("Zero length BigInteger2");
            ...
            if (next <= str.Length)
            {
                do
                {
                    ...
                    BigInteger2 bi = CreateUValueOf(i);
            ...
            RandomNumberGenerator random)
        {
            ...
            for (; ; )
            {
                ...
                {
                    random.GetBytes(bx);
                    this.magnitude[j] ^= BitConverter.ToInt32(bx, 0);
        ...
        private BigInteger2 AddToMagnitude(
            int[] magToAdd)
        {
            int[] big, small;
            ...
            return new BigInteger2(this.sign, bigCopy, possibleOverflow);
        }

        public BigInteger2 And(
            BigInteger2 value)
        {
            ...
            int resultLength = global::System.Math.Max(aMag.Length, bMag.Length);
            ...
            BigInteger2 result = new BigInteger2(1, resultMag, true);
        ...
        public int CompareTo(
            object obj)
        {
            return CompareTo((BigInteger2)obj);
        }
            ...
            BigInteger2 val)
        {
            ...
            {
                BigInteger2 result = this.Abs().ShiftRight(val.Abs().BitLength - 1);
                return val.sign == this.sign ? result : result.Negate();
            }

            int[] mag = (int[])this.magnitude.Clone();

            return new BigInteger2(this.sign * val.sign, Divide(mag, val.magnitude), true);
        }

        public BigInteger2[] DivideAndRemainder(
            BigInteger2 val)
        {
            if (val.sign == 0)
                throw new ArithmeticException("Division by zero error");

            BigInteger2[] biggies = new BigInteger2[2];
            ...
            else if (val.QuickPow2Check()) // val is power of two
            {
                ...
                BigInteger2 quotient = this.Abs().ShiftRight(e);
                int[] remainder = this.LastNBits(e);

                biggies[0] = val.sign == this.sign ? quotient : quotient.Negate();
                biggies[1] = new BigInteger2(this.sign, remainder, true);
            }
            else
            {
                ...
                biggies[0] = new BigInteger2(this.sign * val.sign, quotient, true);
                biggies[1] = new BigInteger2(this.sign, remainder, true);
            }
            ...
            object obj)
        {
            ...
            BigInteger2 biggie = obj as BigInteger2;
            if (biggie == null)
                return false;
        ...
        private bool IsEqualMagnitude(BigInteger2 x)
        {
        ...
        // TODO Make public?
        private BigInteger2 Inc()
        {
            if (this.sign == 0)
                return One;

            if (this.sign < 0)
                return new BigInteger2(-1, doSubBigLil(this.magnitude, One.magnitude), true);
        ...
        /**
         * return whether or not a BigInteger2 is probably prime with a
        ...
        private bool CheckProbablePrime(int certainty, RandomNumberGenerator random, bool randomlySelected)
        {
            ...
            int numLists = global::System.Math.Min(BitLength - 1, primeLists.Length);
        ...
        public bool RabinMillerTest(int certainty, RandomNumberGenerator random)
        {
            return RabinMillerTest(certainty, random, false);
        }

        internal bool RabinMillerTest(int certainty, RandomNumberGenerator random, bool randomlySelected)
        {
            int bits = BitLength;
            ...
            if (randomlySelected)
            {
                ...
                if (certainty < 100)
                {
                    iterations = global::System.Math.Min(itersFor100Cert, iterations);
                }
                else
                {
                    iterations -= 50;
            ...
            Debug.Assert(s >= 1);
            BigInteger2 r = n.ShiftRight(s);

            // NOTE: Avoid conversion to/from Montgomery form and check for R/-R as result instead

            BigInteger2 montRadix = One.ShiftLeft(32 * n.magnitude.Length).Remainder(n);
            BigInteger2 minusMontRadix = n.Subtract(montRadix);
        ...
        //
        //			BigInteger2 n = this;
        //			BigInteger2 nMinusOne = n.Subtract(One);
        //			BigInteger2 e = nMinusOne.ShiftRight(1);
        //
        //			do
        //			{
        //				BigInteger2 a;
        //				do
        //				{
        //					a = new BigInteger2(nBitLength, random);
        //				}
        ...
        //					return false;
        //
        //				BigInteger2 check = a.ModPow(e, n);
        //
        ...
        public BigInteger2 Max(
            BigInteger2 value)
        {
            return CompareTo(value) > 0 ? this : value;
        }

        public BigInteger2 Min(
            BigInteger2 value)
        {
            return CompareTo(value) < 0 ? this : value;
        }
            ...
            BigInteger2 m)
        {
            ...
            BigInteger2 biggie = Remainder(m);

            return (biggie.sign >= 0 ? biggie : biggie.Add(m));
        }

        public BigInteger2 ModInverse(
            BigInteger2 m)
        {
            if (m.sign < 1)
                throw new ArithmeticException("Modulus must be positive");
            ...
            //				int k = 0;
            //				BigInteger2 B = One, C = Zero, F = this, G = m, tmp;
            //
            //				for (;;)
            //				{
            ...
            //					if (F.Equals(One))
            //					{
            //						BigInteger2 half = m.Add(One).ShiftRight(1);
            //						BigInteger2 halfK = half.ModPow(BigInteger2.ValueOf(k), m);
            ...
            BigInteger2 d = this.Remainder(m);
            BigInteger2 x;
            BigInteger2 gcd = ExtEuclid(d, m, out x);
        ...
        private BigInteger2 ModInversePow2(BigInteger2 m)
        {
            ...
            BigInteger2 x = BigInteger2.ValueOf(inv64);
            ...
            if (pow > 64)
            {
                ...
                do
                {
                    BigInteger2 t = x.Multiply(d).Remainder(m);
        ...
        private static BigInteger2 ExtEuclid(BigInteger2 a, BigInteger2 b, out BigInteger2 u1Out)
        {
            BigInteger2 u1 = One, v1 = Zero;
            BigInteger2 u3 = a, v3 = b;

            if (v3.sign > 0)
            {
                for (; ; )
                {
                    BigInteger2[] q = u3.DivideAndRemainder(v3);
                    u3 = v3;
                    v3 = q[1];

                    BigInteger2 oldU1 = u1;
                    u1 = v1;
        ...
        public BigInteger2 ModPow(BigInteger2 e, BigInteger2 m)
        {
            if (m.sign < 1)
                throw new ArithmeticException("Modulus must be positive");
        ...
        private static BigInteger2 ModPowBarrett(BigInteger2 b, BigInteger2 e, BigInteger2 m)
        {
            int k = m.magnitude.Length;
            BigInteger2 mr = One.ShiftLeft((k + 1) << 5);
            BigInteger2 yu = One.ShiftLeft(k << 6).Divide(m);
            ...
            BigInteger2[] oddPowers = new BigInteger2[numPowers];
            oddPowers[0] = b;

            BigInteger2 b2 = ReduceBarrett(b.Square(), m, mr, yu);
        ...
        private static BigInteger2 ReduceBarrett(BigInteger2 x, BigInteger2 m, BigInteger2 mr, BigInteger2 yu)
        {
            ...
            if (xLen - mLen > 1)
            {
                ...
                BigInteger2 q1 = x.DivideWords(k - 1);
                BigInteger2 q2 = q1.Multiply(yu); // TODO Only need partial multiplication here
                BigInteger2 q3 = q2.DivideWords(k + 1);

                BigInteger2 r1 = x.RemainderWords(k + 1);
                BigInteger2 r2 = q3.Multiply(m); // TODO Only need partial multiplication here
                BigInteger2 r3 = r2.RemainderWords(k + 1);
        ...
        private static BigInteger2 ModPowMonty(BigInteger2 b, BigInteger2 e, BigInteger2 m, bool convert)
        {
            ...
            int[] zSquared = new int[zVal.Length];
            zVal.CopyTo(zSquared, 0);
            SquareMonty(yAccum, zSquared, m.magnitude, mDash, smallMontyModulus);

            for (int i = 1; i < numPowers; ++i)
            {
                oddPowers[i] = new int[oddPowers[i - 1].Length];
                oddPowers[i - 1].CopyTo(oddPowers[i], 0);
            ...
            {
                yVal = new int[oddPowers[mult >> 1].Length];
                oddPowers[mult >> 1].CopyTo(yVal, 0);
            }
            ...
            return new BigInteger2(1, yVal, true);
        }
            ...
            BigInteger2 val)
        {
            ...
            if (val.QuickPow2Check()) // val is power of two
            {
                BigInteger2 result = this.ShiftLeft(val.Abs().BitLength - 1);
                return val.sign > 0 ? result : result.Negate();
            }

            if (this.QuickPow2Check()) // this is power of two
            {
                BigInteger2 result = val.ShiftLeft(this.Abs().BitLength - 1);
            ...
            return new BigInteger2(resSign, res, true);
        }

        public BigInteger2 Square()
        {
            if (sign == 0)
                return Zero;
            ...
            return new BigInteger2(1, res, false);
        }
        ...
        public BigInteger2 Negate()
        {
            ...
            return new BigInteger2(-sign, magnitude, false);
        }

        public BigInteger2 NextProbablePrime()
        {
            if (sign < 0)
        ...
        public BigInteger2 Not()
        {
            return Inc().Negate();
        }

        public BigInteger2 Pow(int exp)
        {
            if (exp <= 0)
            {
                if (exp < 0)
        ...
        public static BigInteger2 ProbablePrime(
            int bitLength,
            RandomNumberGenerator random)
        {
            return new BigInteger2(bitLength, 100, random);
        }
            ...
            BigInteger2 n)
        {
            ...
            if (n.magnitude.Length == 1)
            {
                ...
                if (val > 0)
                {
                    ...
                    return rem == 0
                        ? Zero
                        : new BigInteger2(sign, new int[] { rem }, false);
                }
            }
            ...
            return new BigInteger2(sign, result, true);
        }
            ...
            int n)
        {
            ...
            numWords = global::System.Math.Min(numWords, this.magnitude.Length);
        ...
        private BigInteger2 DivideWords(int w)
        {
            Debug.Assert(w >= 0);
            int n = magnitude.Length;
            if (w >= n)
            ...
            return new BigInteger2(sign, mag, false);
        }

        private BigInteger2 RemainderWords(int w)
        {
            Debug.Assert(w >= 0);
            int n = magnitude.Length;
            if (w >= n)
            ...
            int n)
        {
            ...
            BigInteger2 result = new BigInteger2(sign, ShiftLeft(magnitude, n), true);
            ...
            int n)
        {
            ...
            //
            //			return new BigInteger2(this.sign, res, true);
            ...
            return new BigInteger2(this.sign, res, false);
        }
            ...
            BigInteger2 n)
        {
            ...
            return new BigInteger2(this.sign * compare, doSubBigLil(bigun.magnitude, lilun.magnitude), true);
        }
                ...
                case 10:
                    {
                        ...
                        BigInteger2 bigPower = BigInteger2.ValueOf(power);

                        IList S = new ArrayList();
                        while (q.CompareTo(bigPower) >= 0)
                        {
                            BigInteger2[] qr = q.DivideAndRemainder(bigPower);
        ...
        private static BigInteger2 CreateUValueOf(
            ulong value)
        {
            ...
            if (msw != 0)
                return new BigInteger2(1, new int[] { msw, lsw }, false);

            if (lsw != 0)
            {
                BigInteger2 n = new BigInteger2(1, new int[] { lsw }, false);
        ...
        private static BigInteger2 CreateValueOf(
            long value)
        {
            if (value < 0)
            {
        ...
        public static BigInteger2 ValueOf(
            long value)
        {
        ...
        private BigInteger2 FlipExistingBit(
            int n)
        {
            Debug.Assert(sign > 0);
            Debug.Assert(n >= 0);
            ...
            return new BigInteger2(this.sign, mag, false);
        }
    }
}
